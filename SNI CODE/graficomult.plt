...
plot 'mercado.csv' using 1:4 with lines title "Produzidos" lt rgb "green", \
     'mercado.csv' using 1:5 with lines title "Consumidos" lt rgb "purple", \
     'mercado.csv' using 1:15 with lines title "Prod_total" lt rgb "red"

# Gráfico 3: Contratações e Demissões
set title "Taxa de desemprego"
plot 'mercado.csv' using 1:12 with lines title "desemprego %" lt rgb "orange"
...
plot 'mercado.csv' using 1:10 with lines title "Riqueza media" lt rgb "yellow"

# Gráfico 6: Variável Customizada (Exemplo)
set title "Capital medio das empresas"
plot 'mercado.csv' using 1:9 with lines title "Capital medio" lt rgb "magenta"

# Gráfico 7: Variável Customizada (Exemplo)
set title "Numero de empresas ativas"
plot 'mercado.csv' using 1:14 with lines title "ativas" lt rgb "green"
